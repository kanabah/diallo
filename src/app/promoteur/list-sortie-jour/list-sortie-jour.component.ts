...
@Component({
  selector: 'app-list-sortie-jour',
  templateUrl: './list-sortie-jour.component.html',
  styleUrls: ['./list-sortie-jour.component.css']
})
export class ListSortieJourComponent implements OnInit {
  dataSource: any[] = [];
